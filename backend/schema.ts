...
export const userSchema = z.object({
  ...
  user_role: z.enum(['customer', 'host', 'admin', 'vip_customer']).default('customer'),
...
export const createUserInputSchema = z.object({
  ...
  user_role: z.enum(['customer', 'host', 'admin', 'vip_customer']).default('customer').optional(),
...
export const updateUserInputSchema = z.object({
  ...
  phone_number: z.string().max(20).nullable().optional(),
  date_of_birth: z.string().nullable().optional(),
  user_role: z.enum(['customer', 'host', 'admin', 'vip_customer']).optional(),
  loyalty_tier: z.enum(['bronze', 'silver', 'gold', 'platinum']).nullable().optional(),
